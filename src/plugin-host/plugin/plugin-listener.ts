...
export interface IPluginListener {
    ...
    /**
     * Fired when a plugin wants to send a dice type animated emoji to a chat.
     * @param chatId Chat to send Dice to.
     ...
     */
    onPluginWantsToSendDice(chatId: number, emoji: string, replyToMessageId?: number, forceReply?: boolean): Promise<TelegramBot.Message | void>;
