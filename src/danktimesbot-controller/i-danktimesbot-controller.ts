...
import { IPluginListener } from "../plugin-host/plugin/plugin-listener";
 ...
 */
export interface IDankTimesBotController extends ITelegramClientListener, IChatRegistryListener, IPluginListener {
